...
echo $yellow
figlet -f future "SHUTDOWN INDO TEAM"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
echo $Anonymous37"	~"$cyan"{"$white"A"$cyan"}"$green"."$yellow"Tebas Index"$cyan
echo $indigo"        ~"$cyan"{"$white"B"$cyan"}"$green"."$yellow"Web Scanner~"$cyan
echo $indigo"	~"$cyan"{"$white"C"$cyan"}"$green"."$yellow"Auto Deface/Deface Masal"$cyan
echo
echo $cyan"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo
echo $indigo"  +"$cyan"{"$white"T"$cyan"}"$purple"."$green"LIVE TARGET"$indigo"      +"$cyan"{"$white"I"$cyan"}"$green"Info"$indigo"      +"$cyan"{"$white"Q"$cyan"}"$green"Quit"$cyan
echo $cyan"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.TamfanX"$cyan" ~/SIT"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Mr.TamfanX"$cyan" ~/SIT"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Mr.TamfanX"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Mr.TamfanX"$cyan" ~/SIT"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"Mr.TamfanX"$cyan" ~/Crot"$white
read -p " ╰─$ " target5
...
echo $red"##########################$green" Anonymous37 "$red###########################"
echo $green"Author  : Mr.TamfanX			"
echo $purple"Gthub   : https://github.com/Anonymous3-SIT"
...
echo $cyan"[+] SIT_GM "
echo $cyan"[+] Mr.Zonk "
echo $cyan"[+] Mr.TamfanX & All Member [S.I.T] "
echo $red"##########################$green" Anonymous37 "$red###########################"
